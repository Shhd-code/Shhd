...
-- ط¥ظ†ط´ط§ط، ط§ظ„ظˆط§ط¬ظ‡ط©
local sg = Instance.new("ScreenGui")
sg.Name = "Shahd_Draggable_Pro"
sg.ResetOnSpawn = false
sg.Parent = localPlayer.PlayerGui

-- ط¯ط§ظ„ط© ظ„ط¬ط¹ظ„ ط £ظٹ ط¹ظ†طμط± ظ‚ط§ط¨ظ„ ظظ„ط³طط¨ (ط¹ط´ط§ظ† ظٹط´طھط;ظ„ ط¹ظ„ظ‰ ط§ظ„ظ…ظˆط¨ط§ظٹظ„ ظˆط§ظ‹ظظظ…ط¨ظٹظˆطھط±)
دالة محلية makeDraggable(frame)
    السحب المحلي، إدخال السحب، بداية السحب، موضع البداية
    frame.InputBegan:Connect(function(input)
        إذا كان نوع إدخال المستخدم يساوي Enum.UserInputType.MouseButton1 أو نوع إدخال المستخدم يساوي Enum.UserInputType.Touch،
            السحب = صحيح
            dragStart = input.Position
            startPos = frame.Position
            input.Changed:Connect(function()
                إذا كانت حالة إدخال المستخدم تساوي Enum.UserInputState.End، فإن السحب = خطأ.
            نهاية)
        نهاية
    نهاية)
    frame.InputChanged:Connect(function(input)
        إذا كان نوع إدخال المستخدم يساوي Enum.UserInputType.MouseMovement أو Enum.UserInputType يساوي Enum.UserInputType.Touch،
            dragInput = input
        نهاية
    نهاية)
    UserInputService.InputChanged:Connect(function(input)
        إذا كان الإدخال يساوي dragInput وكان السحب جارياً،
...
-----------------------------------------
-- [ ط§ظ„ظ„ظˆطط© ط§ظ„ظƒط¨ظٹط±ط© - اللوحة الرئيسية ]
-----------------------------------------
...
mainFrame.Parent = sg
makeDraggable(mainFrame) -- طھظپط¹ظٹظ„ ط§ظ„ط³طط¨ ظ„ظ„ظˆطط© ط§ظ„ظƒط¨ظٹط±ط©
...
title.Text = "Shahd Queen UI ًں''ًں¤ک"
title.TextColor3 = Color3.new(1,1,1)
title.TextScaled = true
title.Font = Enum.Font.FredokaOne
title.BackgroundTransparency = 1

-- ظ…ط±ط¨ط¹ ط§ظ„ظƒطھط§ط¨ط© ط§ظ„ط±ط¦ظٹط³ظٹ
...
mainInput.PlaceholderText = "ط¹ظ…ظˆ ط§ظƒطھط¨ ظ‡ظ†ط§... ںک‰"
mainInput.Text = ""
...
لكل i و v في أزواج الألوان ipairs(colors) نفّذ
    local cBtn = Instance.new("TextButton", colorFrame)
    cBtn.Size = UDim2.new(0, 35, 0, 35)
    cBtn.Position = UDim2.new(0, (i-1)*45 + 5, 0, 5)
    cBtn.BackgroundColor3 = vC
    cBtn.Text = ""
    Instance.new("UICorner", cBtn).CornerRadius = UDim.new(0.3, 0)
    cBtn.MouseButton1Click:Connect(function()
        اللون المحدد = v.Tag
        mainStroke.Color = vC
        إذا كان sg:FindFirstChild("MiniInputFrame")
            sg.MiniInputFrame.UIStroke.Color = vC
        نهاية
    نهاية)
نهاية

-----------------------------------------
-- [ ط§ظ„ظ…ط±ط¨ط¹ ط§ظ„ظ…ظٹظ†ظٹ ط§ظ„ظ‚ط§ط¨ظ„ ظ„ظ„طھطط±ظٹظƒ - ميني بار قابل للسحب ]
-----------------------------------------
local miniFrame = Instance.new("Frame", sg)
miniFrame.Name = "MiniInputFrame"
miniFrame.Size = UDim2.new(0, 150, 0, 45)
miniFrame.Position = UDim2.new(0, 10, 0.7, 0) -- ظ…ظƒط§ظ† ط§ظ„ط¨ط¯ط§ظٹط©
...
-----------------------------------------
-- [ ط¯ط§ظ‹ط© ط§ظ‹ط¥ط±ط³ط§ظ‹ ظˆطظ‹ ط§ظ‹ظƒظٹط¨ظˆط±ط¯ ]
-----------------------------------------
دالة محلية sendMessage(inputBox)
    النص المحلي = نص مربع الإدخال
    إذا كان النص يساوي "" ثم ارجع نهاية
    
    الحجم المحلي = sizeInput.Text
    ...
    إذا كان عن بعد
        ...
        inputBox.Text = ""
        inputBox:ReleaseFocus() -- ظٹظ‚ظپظ‹ ط§ظ‹ظƒظٹط¨ظˆط±ط¯ ظپظˆط±ط§ظ‹
    نهاية
نهاية

mainInput.FocusLost:Connect(function(enterPressed)
    إذا تم الضغط على زر الإدخال، فأرسل الرسالة (mainInput) نهاية
نهاية)

miniInput.FocusLost:Connect(function(enterPressed)
    إذا تم الضغط على زر الإدخال، فأرسل رسالة (miniInput)
نهاية)

-- ط £ط²ط±ط§ط± ط§ظ„طھطظƒظ…
...
StarterGui:SetCore("SendNotification", {
    العنوان = "نهائي ملكة الجمال"،
    Text = "ظ" ط´ظٹ ظٹطھطط±ظƒ ط§ظ"طظٹظ† ظٹط§ ظ…ظ"ظƒط©! ں'¸ًں'ژ"،
    Icon = pImageId,
    المدة = 5
})
